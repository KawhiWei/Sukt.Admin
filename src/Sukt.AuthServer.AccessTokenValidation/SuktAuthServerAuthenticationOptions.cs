...
{
    /// <summary>
    /// Options for SuktAuthServer authentication
    /// </summary>
    /// <seealso cref="Microsoft.AspNetCore.Authentication.AuthenticationSchemeOptions" />
    public class SuktAuthServerAuthenticationOptions : AuthenticationSchemeOptions
    {
        static readonly Func<HttpRequest, string> InternalTokenRetriever = request => request.HttpContext.Items[SuktAuthServerAuthenticationDefaults.TokenItemsKey] as string;
